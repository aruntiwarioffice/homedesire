                        ...
                        <div className="col-lg-6">
                            <div className="contact-right">
                                ...
                                <div className="list-social">
                                    <ul>
                                        <li><a href="http://twitter.com/" target="_self"><i className="fa fa-twitter"></i></a></li>
                                        <li><a href="http://facebook.com/" target="_self"><i className="fa fa-facebook-f"></i></a></li>
                                        <li><a href="http://linkedin.com/" target="_self"><i className="fa fa-linkedin"></i></a></li>
                                        <li><a href="http://instagram/" target="_self"><i className="fa fa-instagram"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
